...
def execute(filters=None):
	...
	for ss in salary_slips:
		row = [ss.employee, ss.employee_name, ss.branch, ss.designation,
			ss.company, ss.start_date, ss.end_date, ss.leave_without_pay, ss.payment_days, ss.performance]
		...
		if not ss.performance  == None: columns[9] = columns[9].replace('-1','130')
